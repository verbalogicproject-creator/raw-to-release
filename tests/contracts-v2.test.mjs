...
const samples = {
  ...
  'command-receipt.json': { contract_version: '2.0.0', receipt_type: 'command', receipt_id: 'receipt-1', run_id: RUN, task_id: 'task-1', command_id: 'tests', argv: ['node', '--test'], cwd: '.', implementation_sha: G, started_at: '2026-07-30T04:00:00Z', ended_at: '2026-07-30T04:01:00Z', exit_code: 0, outcome: 'pass', test_counts: { passed: 13, failed: 0 }, stdout_sha256: H, stderr_sha256: H, failure_excerpt: '' },
