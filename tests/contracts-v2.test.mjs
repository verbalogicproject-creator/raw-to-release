...
const samples = {
  'approval-receipt.json': { contract_version: '2.0.0', receipt_type: 'plan', receipt_id: 'approval-plan-1', run_id: RUN, user: 'human-1', revision: 1, displayed_content_hash: H, authority_hash: H, confirmed_at: '2026-07-30T04:00:00Z', target: 'plan.md' },
